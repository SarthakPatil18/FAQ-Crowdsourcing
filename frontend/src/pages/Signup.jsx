...
function Signup() {
  ...
  return (
    <div className="auth-page-split-container">
      ...
      {/* Left panel: branding, text, and illustration */}
      <div className="auth-left-panel">
        <div className="auth-left-content">
          <div className="auth-left-logo">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
            <span>CrowdFAQ</span>
          </div>
          <h1>Explore community knowledge & answers.</h1>
          <p>Join the CrowdFAQ community to ask questions, vote on answers, and collaborate on shared knowledge.</p>
        </div>
        <div className="auth-left-image-container">
          <img src="/src/assets/login_bg.png" alt="CrowdFAQ Community" className="auth-left-image" />
        </div>
      </div>
      ...
      <div className="auth-right-panel">
        ...
        <div className="auth-card" style={{ maxWidth: "480px", margin: "40px 0" }}>
